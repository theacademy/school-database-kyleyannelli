...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<TeacherCount> teacherCountByDept() {
        ...
        String sql = "SELECT dept, COUNT(DISTINCT dept) as teacherCount FROM teacher GROUP BY dept";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT c.courseCode, c.courseDesc, COUNT(cs.student_id) as numStudents FROM course AS c"
                + " INNER JOIN course_student AS cs ON cs.course_id = c.cid"
